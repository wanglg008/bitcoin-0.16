...
//通过这个函数，将CMainSignals类中的unique_ptr<MainSignalsInstance>指针类型的成员变量m_internals赋值为一个新建的对象，
//这个新建的对象类型为结构体MainSignalsInstance。总之这个函数是设置变量m_internals成为结构体MainSignalsInstance类型，用
//来注册后台处理信号。
